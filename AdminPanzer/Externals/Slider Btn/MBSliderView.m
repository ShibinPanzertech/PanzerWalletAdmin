...
//        _label.animated = YES;
        ...
        [_slider setThumbImage:[UIImage imageNamed:@"on_blue_64.png"] forState:UIControlStateNormal];
...
- (void)layoutSubviews {
    ...
    if ([[NSUserDefaults standardUserDefaults] boolForKey:@"DisplayBlueSwitch"] == true) {
        [_slider setThumbImage:[UIImage imageNamed:@"on_blue_64.png"] forState:UIControlStateNormal];
    }else{
        [_slider setThumbImage:[UIImage imageNamed:@"on_white_64.png"] forState:UIControlStateNormal];
    }
